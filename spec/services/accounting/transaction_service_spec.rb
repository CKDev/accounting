...
RSpec.describe Accounting::TransactionService do
  ...
  before(:each) do
    payment_card              = Accounting::Payment.create!(profile_id: profile.id, profile_type: :card, last_four: service_card.last_four, number: "1111111111111111", ccv: 123, month: 1, year: 2080, payment_profile_id: 1, address_attributes: { first_name: 'Test', last_name: 'Tester', street_address: '123 Fake St', city: 'Denver', state: 'CO', zip: '11111', address_id: 1 })
    ...
    payment_subscription_card = Accounting::Payment.create!(profile_id: profile_subscription.id, profile_type: :card, last_four: service_subscription.last_four, number: "1111111111111111", ccv: 123, month: 1, year: 2080, payment_profile_id: 3, address_attributes: { first_name: 'Test', last_name: 'Tester', street_address: '123 Fake St', city: 'Denver', state: 'CO', zip: '11111', address_id: 3 })
