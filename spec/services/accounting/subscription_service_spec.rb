...
RSpec.describe Accounting::SubscriptionService do
  ...
  let(:hook_payment)          { ActionController::Parameters.new({ "notificationId" => "35f96318-03c4-419e-922f-2b0fb561b885", "eventType" => "net.authorize.customer.paymentProfile.created", "eventDate" => "2017-09-21T04:45:36.437607Z", "webhookId" => "82ed4771-17bb-4fc6-8ea4-f0cad81d3414", "payload" => { "customerProfileId" => 1502473210, "entityName" => "customerPaymentProfile", "id" => "1501998893" }}) }
  let(:hook_subscription)     { ActionController::Parameters.new({ "notificationId" => "d68c0825-5ba8-40b9-97db-f16274731fab", "eventType" => "net.authorize.customer.subscription.created", "eventDate" => "2017-09-21T19:57:18.9398092Z", "webhookId" => "82ed4771-17bb-4fc6-8ea4-f0cad81d3414", "payload" => { "name" => "Test", "amount" => 4.0, "status" => "canceled", "profile" => {"customerProfileId" => 1502474889, "customerPaymentProfileId" => 1501998893}, "entityName" => "subscription", "id" => "4765887"}, "hook"=>{"notificationId" => "d68c0825-5ba8-40b9-97db-f16274731fab", "eventType" => "net.authorize.customer.subscription.created", "eventDate" => "2017-09-21T19:57:18.9398092Z", "webhookId" => "82ed4771-17bb-4fc6-8ea4-f0cad81d3414", "payload" => {"name" => "Test", "amount"=>4.0, "status" => "canceled", "profile" => {"customerProfileId" => 1502474889, "customerPaymentProfileId" => 1501998893}, "entityName" => "subscription", "id" => "4765887" }}}) }
